...
Model Context Protocol server that provides search capabilities for documentation
stored in Azure Cognitive Search. This server exposes tools for searching, retrieving,
and managing documentation for LLM interactions.
"""
...
app = Server("documentation-retrieval-mcp-server")
...
async def handle_list_tools() -> list[types.Tool]:
    """List available tools for documentation search and management."""
...
async def main():
    ...
    logger.info("[START] Starting Documentation Retrieval MCP Server")
        ...
        async with mcp.server.stdio.stdio_server() as (read_stream, write_stream):
            await app.run(
                ...
                InitializationOptions(
                    server_name="documentation-retrieval-mcp-server",
